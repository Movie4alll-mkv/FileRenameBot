        ...
        try:
            ...
            await update.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text="Join My Updates Channels", url=f"https://t.me/{update_channel}", url=f"https://t.me/{update_channel}", url=f"https://t.me/{update_channel}", url=f"https://t.me/{update_channel}")]
              ])
            )
            return
        else:
